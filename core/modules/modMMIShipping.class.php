...
class modMMIShipping extends DolibarrModules
{
	...
	public function init($options = '')
	{
		...
		$extrafields->addExtraField('total_shipping_real_price', $langs->trans('Extrafield_total_real_price'), 'price', 100, '', 'expedition', 0, 0, '', '', 1, '', -1, $langs->trans('ExtrafieldToolTip_total_real_price'), '', $conf->entity, 'mmishipping@mmishipping', '$conf->mmishipping->enabled');
