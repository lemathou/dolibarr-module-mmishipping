...
class modMMIShipping extends DolibarrModules
{
	...
	public function init($options = '')
	{
		...
		$extrafields->addExtraField('fk_order_line', $langs->trans('Extrafield_fk_order_line'), 'link', 100, '', 'expedition', 0, 0, '', array('options'=>array('OrderLine:commande/class/order.class.php'=>null)), 1, '', 3, $langs->trans('ExtrafieldToolTip_fk_order_line'), '', $conf->entity, 'mmishipping@mmishipping', '$conf->mmishipping->enabled || $conf->mmifournisseurprice->enabled');
		// Shipping supplier metadata
		$extrafields->addExtraField('total_shipping_expected_price', $langs->trans('Extrafield_total_shipping_expected_price'), 'price', 100, '', 'expedition', 0, 0, '', '', 1, '', -1, $langs->trans('ExtrafieldToolTip_total_shipping_expected_price'), '', $conf->entity, 'mmishipping@mmishipping', '$conf->mmishipping->enabled');
		$extrafields->addExtraField('total_shipping_real_price', $langs->trans('Extrafield_total_shipping_real_price'), 'price', 100, '', 'expedition', 0, 0, '', '', 1, '', -1, $langs->trans('ExtrafieldToolTip_total_shipping_real_price'), '', $conf->entity, 'mmishipping@mmishipping', '$conf->mmishipping->enabled');
