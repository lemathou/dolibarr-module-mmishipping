...
class modMMIShipping extends DolibarrModules
{
	...
	public function init($options = '')
	{
		...
		// Shipping
		$extrafields->addExtraField('fk_entrepot', $langs->trans('Extrafield_fk_entrepot'), 'link', 10, '', 'expedition', 0, 0, '', array('options'=>array('Entrepot:product/stock/class/entrepot.class.php'=>null)), 1, '', -1, $langs->trans('ExtrafieldToolTip_fk_entrepot'), '', $conf->entity, 'mmishipping@mmishipping', '$conf->mmishipping->enabled || $conf->mmifournisseurprice->enabled');
		$extrafields->addExtraField('fk_adresse', $langs->trans('Extrafield_fk_adresse'), 'link', 10, '', 'expedition', 0, 0, '', array('options'=>array('Contact:contact/class/contact.class.php'=>null)), 1, '', -1, $langs->trans('ExtrafieldToolTip_fk_adresse'), '', $conf->entity, 'mmishipping@mmishipping', '$conf->mmishipping->enabled');
		$extrafields->addExtraField('fk_order_line', $langs->trans('Extrafield_fk_order_line'), 'link', 20, '', 'expedition', 0, 0, '', array('options'=>array('OrderLine:commande/class/commande.class.php'=>null)), 1, '', 3, $langs->trans('ExtrafieldToolTip_fk_order_line'), '', $conf->entity, 'mmishipping@mmishipping', '$conf->mmishipping->enabled || $conf->mmifournisseurprice->enabled');
		// Shipping supplier metadata
		$extrafields->addExtraField('total_shipping_expected_price', $langs->trans('Extrafield_total_shipping_expected_price'), 'price', 50, '', 'expedition', 0, 0, '', '', 1, '', -1, $langs->trans('ExtrafieldToolTip_total_shipping_expected_price'), '', $conf->entity, 'mmishipping@mmishipping', '$conf->mmishipping->enabled');
		$extrafields->addExtraField('total_shipping_real_price', $langs->trans('Extrafield_total_shipping_real_price'), 'price', 51, '', 'expedition', 0, 0, '', '', 1, '', -1, $langs->trans('ExtrafieldToolTip_total_shipping_real_price'), '', $conf->entity, 'mmishipping@mmishipping', '$conf->mmishipping->enabled');
		$extrafields->addExtraField('real_weight', $langs->trans('Extrafield_real_weight'), 'double', 51, '10,5', 'expedition', 0, 0, '', '', 1, '', -1, $langs->trans('ExtrafieldToolTip_real_weight'), '', $conf->entity, 'mmishipping@mmishipping', '$conf->mmishipping->enabled');
		$extrafields->addExtraField('carrier_metadata', $langs->trans('Extrafield_carrier_metadata'), 'text', 51, '', 'expedition', 0, 0, '', '', 1, '', -1, $langs->trans('ExtrafieldToolTip_carrier_metadata'), '', $conf->entity, 'mmishipping@mmishipping', '$conf->mmishipping->enabled');
		$extrafields->addExtraField('carrier_invoice_updated', $langs->trans('Extrafield_carrier_invoice_updated'), 'boolean', 51, '', 'expedition', 0, 0, '', '', 1, '', -1, $langs->trans('ExtrafieldToolTip_carrier_invoice_updated'), '', $conf->entity, 'mmishipping@mmishipping', '$conf->mmishipping->enabled');

		// Supplier order
		$extrafields->addExtraField('fk_entrepot', $langs->trans('Extrafield_fk_entrepot'), 'link', 10, '', 'commande_fournisseur', 0, 0, '', array('options'=>array('Entrepot:product/stock/class/entrepot.class.php'=>null)), 1, '', -1, $langs->trans('ExtrafieldTooltip_fk_entrepot'), '', $conf->entity, 'mmishipping@mmishipping', '$conf->mmishipping->enabled');
		$extrafields->addExtraField('fk_adresse', $langs->trans('Extrafield_fk_adresse'), 'link', 10, '', 'commande_fournisseur', 0, 0, '', array('options'=>array('Contact:contact/class/contact.class.php'=>null)), 1, '', -1, $langs->trans('ExtrafieldTooltip_fk_adresse'), '', $conf->entity, 'mmishipping@mmishipping', '$conf->mmishipping->enabled');

		// Reception
		$extrafields->addExtraField('fk_entrepot', $langs->trans('Extrafield_fk_entrepot'), 'link', 10, '', 'reception', 0, 0, '', array('options'=>array('Entrepot:product/stock/class/entrepot.class.php'=>null)), 1, '', -1, $langs->trans('ExtrafieldTooltip_commande_fournisseur_fk_entrepot'), '', $conf->entity, 'mmishipping@mmishipping', '$conf->mmishipping->enabled');
		$extrafields->addExtraField('fk_adresse', $langs->trans('Extrafield_fk_adresse'), 'link', 10, '', 'reception', 0, 0, '', array('options'=>array('Contact:contact/class/contact.class.php'=>null)), 1, '', -1, $langs->trans('ExtrafieldTooltip_fk_adresse'), '', $conf->entity, 'mmishipping@mmishipping', '$conf->mmishipping->enabled');
